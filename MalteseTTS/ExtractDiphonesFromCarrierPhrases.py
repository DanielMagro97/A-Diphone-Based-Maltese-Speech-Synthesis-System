...
if __name__ == '__main__':
    ...
    with open('DMagroCarrierPhrasesMT\\diphone_list.txt', 'r', encoding='utf-8') as diphone_dictionary:
        ...
        for entry in diphone_dictionary:
            ...
            if len(line_list) == 4:
                ...
                diphone_wav_end_time: float = float(line_list[3])

                # load the current diphone's carrier word
                fs, carrier_word_samples = scipy.io.wavfile.read('DMagroCarrierPhrasesMT\\recordings\\' + diphone_wav_file + '.wav')
                ...
                scipy.io.wavfile.write(r'diphones\DMagroDiphonesMT\\'+diphone_name+'.wav' , fs, diphone_samples)
