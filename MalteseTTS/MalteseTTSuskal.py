...
import DiphoneConcatenation     # for joining a list of diphones together using TD-PSOLA (or otherwise)


# function which, given a list of arpabet symbols, returns a list of diphones
def arpabet_list_to_diphones(arpabet_list: List[str], silence_symbol: str = 'pau') -> List[str]:
    ...
    # diphones_list.append(silence_symbol + '-' + arpabet_list[0])
...
if __name__ == '__main__':
    ...
    # TODO: Front End (NSW handling etc) goes somewhere here
    ...
    for word_diphones in tokens_arpabet_diphones:
        ...
        # text_arpabet_diphones.append('pau-pau')
    ...
    diphone_set: str = r'diphones\cmu_us_kal\\'
